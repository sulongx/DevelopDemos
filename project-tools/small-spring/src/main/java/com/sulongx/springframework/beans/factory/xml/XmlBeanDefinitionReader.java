...
import com.sulongx.springframework.context.annotation.ClassPathBeanDefinitionScanner;
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException, DocumentException {
        ...
        if (componentScan != null) {
            ...
            if (StrUtil.isEmpty(scanPath)) {
                throw new BeansException("The value of base-package attribute can not empty or null");
            }
